...
def main():
    ...
    """
    # 읽어올 문서 파일의 경로를 설정함
    file_path = r"24.75\data\29회 보험중개사 시험 합격자 명단.pdf"
    ...
    if filtered_documents:
        ...
        # print(filtered_documents[1].page_content)
        # print(filtered_documents[2].page_content)
        # print(filtered_documents[3].page_content)
        # print(filtered_documents[4].page_content)
    else:
        print("필터링된 문서가 없음")
